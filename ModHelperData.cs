...
{
    public const string Name = "Lives and Bananite Editor";
    public const string Description = "Click on your bananite or lives count in Frontiers Legends to edit them to any value you want.";
